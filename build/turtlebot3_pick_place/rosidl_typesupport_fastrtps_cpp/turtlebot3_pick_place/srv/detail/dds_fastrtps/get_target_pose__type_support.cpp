...
#include "turtlebot3_pick_place/srv/detail/get_target_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlebot3_pick_place
cdr_serialize(
  const turtlebot3_pick_place::srv::GetTargetPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlebot3_pick_place::srv::GetTargetPose_Request & ros_message)
{
  // Member: target_class
  cdr >> ros_message.target_class;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot3_pick_place::srv::GetTargetPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlebot3_pick_place::srv::GetTargetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlebot3_pick_place::srv::GetTargetPose_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_turtlebot3_pick_place
const rosidl_message_type_support_t *
get_message_type_support_handle<turtlebot3_pick_place::srv::GetTargetPose_Request>()
{
  return &turtlebot3_pick_place::srv::typesupport_fastrtps_cpp::_GetTargetPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_pick_place, srv, GetTargetPose_Request)() {
  return &turtlebot3_pick_place::srv::typesupport_fastrtps_cpp::_GetTargetPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlebot3_pick_place
cdr_serialize(
  const turtlebot3_pick_place::srv::GetTargetPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlebot3_pick_place::srv::GetTargetPose_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlebot3_pick_place::srv::GetTargetPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlebot3_pick_place::srv::GetTargetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtlebot3_pick_place::srv::GetTargetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtlebot3_pick_place::srv::typesupport_fastrtps_cpp::_GetTargetPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_pick_place, srv, GetTargetPose_Response)() {
  return &turtlebot3_pick_place::srv::typesupport_fastrtps_cpp::_GetTargetPose_Response__handle;
}
...
{
  return &turtlebot3_pick_place::srv::typesupport_fastrtps_cpp::_GetTargetPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_pick_place, srv, GetTargetPose)() {
  return &turtlebot3_pick_place::srv::typesupport_fastrtps_cpp::_GetTargetPose__handle;
}
