...
static const _GetTargetPose_Request_type_support_symbol_names_t _GetTargetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_pick_place, srv, GetTargetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_pick_place, srv, GetTargetPose_Request)),
  }
};
...
{
  return &::turtlebot3_pick_place::srv::rosidl_typesupport_cpp::GetTargetPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_pick_place, srv, GetTargetPose_Request)() {
  return get_message_type_support_handle<turtlebot3_pick_place::srv::GetTargetPose_Request>();
}
...
static const _GetTargetPose_Response_type_support_symbol_names_t _GetTargetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_pick_place, srv, GetTargetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_pick_place, srv, GetTargetPose_Response)),
  }
};
...
{
  return &::turtlebot3_pick_place::srv::rosidl_typesupport_cpp::GetTargetPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_pick_place, srv, GetTargetPose_Response)() {
  return get_message_type_support_handle<turtlebot3_pick_place::srv::GetTargetPose_Response>();
}
...
static const _GetTargetPose_type_support_symbol_names_t _GetTargetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_pick_place, srv, GetTargetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_pick_place, srv, GetTargetPose)),
  }
};
...
{
  return &::turtlebot3_pick_place::srv::rosidl_typesupport_cpp::GetTargetPose_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_pick_place, srv, GetTargetPose)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<turtlebot3_pick_place::srv::GetTargetPose>();
}
