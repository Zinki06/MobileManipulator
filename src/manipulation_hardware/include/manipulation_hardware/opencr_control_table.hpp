...
#ifndef MANIPULATION_HARDWARE__OPENCR_CONTROL_TABLE_HPP_
#define MANIPULATION_HARDWARE__OPENCR_CONTROL_TABLE_HPP_
...
typedef struct
{
  ...
  ControlItem goal_position_read = {222, 1};
...
#endif  // MANIPULATION_HARDWARE__OPENCR_CONTROL_TABLE_HPP_
