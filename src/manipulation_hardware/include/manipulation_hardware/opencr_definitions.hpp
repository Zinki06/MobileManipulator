...
#ifndef MANIPULATION_HARDWARE__OPENCR_DEFINITIONS_HPP_
#define MANIPULATION_HARDWARE__OPENCR_DEFINITIONS_HPP_
...
constexpr double RAW_VELOCITY_TO_RAD_PER_SEC = 0.229 * (2.0 * M_PI) / 60.0;
...
#endif  // MANIPULATION_HARDWARE__OPENCR_DEFINITIONS_HPP_
